<template>
  <div class="flex flex-col items-center justify-center min-h-screen">
    <div class="max-w-[768px] w-full flex-1 overflow-auto">
      <p>123</p>
      <p>123</p>
      <p>123</p>
      <p>123</p>
    ...
    <div class="flex flex-col gap-1 max-w-[768px] w-full">
      <div class="flex flex-col gap-1 p-3  bg-[#f1f1f1] rounded-2xl max-w-[768px] w-full">
        ...
        <div class="flex justify-end">
          <button @click="onChat()"
            :class="question.length === 0 ? 'text-[#f1f1f1] bg-[#cecece]' : 'text-white bg-black'"
      ...
      <p class="py-1 text-xs text-center text-gray-400">内容由AI生成，请注意甄别</p>
    </div>
  </div>
</template>
